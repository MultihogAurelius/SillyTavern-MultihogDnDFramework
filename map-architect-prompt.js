...
Never omit the reverse connection. Never give a reciprocal pair two different detail strings. Never mark a non-entrance area VISITED on creation except on a story-established familiar site where every area is VISITED. Never use kind NPC. Never split a pack into many identical CREATURE assets. Never make a chapel, inn, shop, or house its own settlement area. Never use OBJECT for a structure.
