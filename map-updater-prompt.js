...
Before answering, silently verify: valid JSON; exact existing IDs unless ADD_*; durable facts only; every operation has cause; DEAD/DESTROYED has actor; packs are one GROUP with count; ordinary settlement structures are BUILDING and props are OBJECT; exterior-relative footer phrases (behind/outside/near/…) never become new BUILDING assets; clearly observed UNREVEALED landmarks become KNOWN without clearing notEntered; no inferred promotion; no player or [PARTY] names as assets; every met/passed absolute duration was applied once and cleared; future, unknown, or legacy relative durations were not guessed; noop when nothing lasting changed.`;
