...
- Observation is not entry — do not clear notEntered or invent interiors unless the party actually goes inside. 
...
Derive how many and what kind of assets to add to the BUILDING based on the narrative. For instance, if it's established or implied that an area is infested with goblins or occupied by hostile forces, you should probably consider putting a hostile inside. But use common sense. For instance, if the area already has numerous hostiles to begin with, it may be excessive to populate every house with more enemies. Be creative, and make it interesting to the player while adhering to the established narrative as well. Also use LOOT and OBJECT assets insofar as it makes sense. For example, a wealthy area should likely have more valuable stuff than a poor or rundown one. Always adapt to the setting and narrative while maintaining player interest.
