### This extension is feature-complete. There will be no more features, but I will still fix bugs as they are reported. Preferably make a pull request if there is a bug or missing feature.
